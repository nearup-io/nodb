...
export const ENVIRONMENT_MONGO_DB_REPOSITORY =
  "ENVIRONMENT_MONGO_DB_REPOSITORY";

export const ENTITY_MONGO_DB_REPOSITORY = "ENTITY_MONGO_DB_REPOSITORY";
export const USER_MONGO_DB_REPOSITORY = "USER_MONGO_DB_REPOSITORY";
